#ifndef MD_UGENS_HIGHSHELF_SECOND_ORDER_HPP
#define MD_UGENS_HIGHSHELF_SECOND_ORDER_HPP
...
namespace md_ugens {
    ...
    class HighshelfSecondOrder : public SCUnit {
    public:
        explicit HighshelfSecondOrder();

    private:
        md_audio::HighshelfSecondOrder m_filter;
...
#endif /* MD_UGENS_HIGHSHELF_SECOND_ORDER_HPP */