#ifndef MD_UGENS_TILT_SECOND_ORDER_HPP
#define MD_UGENS_TILT_SECOND_ORDER_HPP
...
namespace md_ugens {
    ...
    class TiltSecondOrder : public SCUnit {
    public:
        explicit TiltSecondOrder();

    private:
        md_audio::TiltSecondOrder m_filter;
...
#endif /* MD_UGENS_TILT_SECOND_ORDER_HPP */